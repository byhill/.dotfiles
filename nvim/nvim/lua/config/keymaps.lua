...
nnoremap('<A-h>', '<cmd>vertical resize -2<cr>', { desc = "Decrease Window Width" })
nnoremap('<A-l>', '<cmd>vertical resize +2<cr>', { desc = "Increase Window Width" })
...
nnoremap('<leader>wm', '<cmd>MaximizerToggle<cr>', { desc = "Maximize window toggle", silent = true })
nnoremap('|', "<C-W>v", { desc = "Split window right" })
nnoremap('_', "<C-W>s", { desc = "Split window below" })
